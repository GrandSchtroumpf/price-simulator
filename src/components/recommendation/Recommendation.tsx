...
export default component$(() => {
	...
	return (
		<section id="recommendation">
			...
			<ul style="--index: 0">
				<li>
					<AvatarV width="56" height="56" alt="Photo de profil" />
					<hgroup>
						<h3>Valérie G</h3>
						<p>Janvier 2026</p>
					</hgroup>
				...
				<li style="--index: 1">
					<AvatarN width="56" height="56" alt="Photo de profil" />
					<hgroup>
				...
				<li style="--index: 2">
					<AvatarF width="56" height="56" alt="Photo de profil" />
					<hgroup>
				...
				<li style="--index: 3">
					<AvatarG width="56" height="56" alt="Photo de profil" />
					<hgroup>
						<h3>G The</h3>
				...
				<li style="--index: 4">
					<AvatarW width="56" height="56" alt="Photo de profil" />
					<hgroup>
